        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/tools/paraphrasing-tool" className="text-slate-500 dark:text-slate-400 hover:text-primary transition-colors font-bold text-indigo-500">Paraphraser AI</Link></li>
              <li><Link to="/tools/internet-speed-test" className="text-slate-500 dark:text-slate-400 hover:text-primary transition-colors">Internet Speed Test</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/disclaimer" className="text-slate-500 dark:text-slate-400 hover:text-primary transition-colors">Disclaimer</Link></li>
